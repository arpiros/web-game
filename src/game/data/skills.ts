...
export const SKILLS: readonly SkillDef[] = [
  ...
  },
  {
    id: 'barrier',
    name: '방어막',
    description: '피해를 흡수하는 방어막을 생성한다. (흡수량: 공격력 × 2)',
    mpCost: 25,
    cooldown: 3,
    effects: [{ type: 'shield', amount: 2 }],
    element: 'water',
    rarity: 'rare',
  },
  ...
  },
  {
    id: 'poison_bite',
    name: '독 이빨',
    description: '단일 적에게 독을 부여한다. (3턴, HP 10% 피해)',
    mpCost: 10,
    cooldown: 2,
    effects: [
      { type: 'apply_status', status: 'poison', duration: 3, value: 10 },
    ],
    element: 'dark',
    rarity: 'common',
  },
